(define (domain faults)
  (:requirements :non-deterministic :typing)
        ...
        (:action perform_operation_1_fault
                ...
                :precondition (and (not_fault f1) (not_fault f2) (not_fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7) (not_completed ?o))
        ...
        (:action perform_operation_2_fault
                :parameters (?o - operation)
                :precondition (and (fault f1) (not_fault f2) (not_fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7) (not_completed ?o))
                :effect (and (completed ?o) (not (not_completed ?o))
                        (oneof
                                (and)
        ...
        (:action perform_operation_3_fault
                :parameters (?o - operation)
                :precondition (and (fault f1) (fault f2) (not_fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7) (not_completed ?o))
                :effect (and (completed ?o) (not (not_completed ?o))
                        (oneof
                                (and)
        ...
        (:action perform_operation_4_fault
                :parameters (?o - operation)
                :precondition (and (fault f1) (fault f2) (fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7) (not_completed ?o))
                :effect (and (completed ?o) (not (not_completed ?o))
                        (oneof
                                (and)
        ...
        (:action perform_operation_5_fault
                :parameters (?o - operation)
                :precondition (and (fault f1) (fault f2) (fault f3) (fault f4) (not_fault f5) (not_fault f6) (not_fault f7) (not_completed ?o))
                :effect (and (completed ?o) (not (not_completed ?o))
                        (oneof
                                (and)
        ...
        (:action perform_operation_6_fault
                :parameters (?o - operation)
                :precondition (and (fault f1) (fault f2) (fault f3) (fault f4) (fault f5) (not_fault f6) (not_fault f7) (not_completed ?o))
                :effect (and (completed ?o) (not (not_completed ?o))
                        (oneof
                                (and)
        ...
        (:action perform_operation_7_fault
                :parameters (?o - operation)
                :precondition (and (fault f1) (fault f2) (fault f3) (fault f4) (fault f5) (fault f6) (not_fault f7) (not_completed ?o))
                :effect (and (completed ?o) (not (not_completed ?o))
                        (oneof
                                (and)
